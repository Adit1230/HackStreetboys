...
os.environ["SDL_AUDIODRIVER"] = "dummy"  # ✅ Disable audio to prevent PulseAudio error
...
class Game:
    def __init__(self, troops1, troops2, team_name1, team_name2):
        ...
        try:
            ...
            print(f"Failed to open display: {e}")  # Debugging output if display fails

        pygame.font.init()
        pygame.display.set_caption('Master Royale')
