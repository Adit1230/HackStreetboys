...
def logic(arena_data:dict):
    ...
    deploy_list.list_.append((arena_data["MyTower"].deployable_troops[0],(-10,0)))
    deploy_list.list_.append((arena_data["MyTower"].deployable_troops[1],(10,0)))
